    ...
    return (
        <motion.div variants={container} initial="hidden" animate="show" className="max-w-6xl mx-auto flex flex-col gap-5 relative pb-2">
            ...
            <header className="relative z-10 flex flex-col gap-1 pt-1 mb-1">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm font-medium">Your premium text-to-speech and voice cloning workspace.</p>
            </header>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 relative z-10">
                <motion.div variants={item}>
                    <Link to="/studio" className="block group h-full">
                        <Card className="h-full border border-slate-300 dark:border-slate-700/60 shadow-[0_8px_30px_rgb(0,0,0,0.4)] bg-gradient-to-b from-slate-900/90 to-slate-950/90 backdrop-blur-xl rounded-2xl hover:border-indigo-500/50 hover:shadow-[0_8px_30px_rgb(99,102,241,0.15)] transition-all duration-300 group-hover:-translate-y-1 p-5 overflow-hidden relative">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-lg font-extrabold text-slate-900 dark:text-white mb-2 group-hover:text-indigo-300 transition-colors tracking-tight">TTS Studio</h3>
                                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed font-medium">Synthesize ultra-realistic speech with advanced neural voice models.</p>
                            </div>
                        </Card>
                    </Link>
                </motion.div>
                    ...
                    <Link to="/clone" className="block group h-full">
                        <Card className="h-full border border-slate-300 dark:border-slate-700/60 shadow-[0_8px_30px_rgb(0,0,0,0.4)] bg-gradient-to-b from-slate-900/90 to-slate-950/90 backdrop-blur-xl rounded-2xl hover:border-purple-500/50 hover:shadow-[0_8px_30px_rgb(168,85,247,0.15)] transition-all duration-300 group-hover:-translate-y-1 p-5 overflow-hidden relative">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-lg font-extrabold text-slate-900 dark:text-white mb-2 group-hover:text-purple-300 transition-colors tracking-tight">Voice Cloning</h3>
                                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed font-medium">Instantly clone any voice with just a 5-second audio sample.</p>
                            </div>
                        </Card>
                    </Link>
                </motion.div>
                    ...
                    <Link to="/history" className="block group h-full">
                        <Card className="h-full border border-slate-300 dark:border-slate-700/60 shadow-[0_8px_30px_rgb(0,0,0,0.4)] bg-gradient-to-b from-slate-900/90 to-slate-950/90 backdrop-blur-xl rounded-2xl hover:border-emerald-500/50 hover:shadow-[0_8px_30px_rgb(16,185,129,0.15)] transition-all duration-300 group-hover:-translate-y-1 p-5 overflow-hidden relative">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-lg font-extrabold text-slate-900 dark:text-white mb-2 group-hover:text-emerald-300 transition-colors tracking-tight">Audio History</h3>
                                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed font-medium">Access, download, and manage your previously generated audio files.</p>
                            </div>
                        </Card>
                    </Link>
                </motion.div>
            ...
            {loading ? (
                <motion.div variants={item} className="grid grid-cols-2 md:grid-cols-4 gap-5 relative z-10 pt-4">
                    {[1, 2, 3, 4].map(i => (
                        <Card key={i} className="border border-slate-300 dark:border-slate-700/60 bg-white/90 dark:bg-slate-900/40 backdrop-blur-xl rounded-2xl p-5 shadow-lg">
                            <div className="h-3 bg-slate-100 dark:bg-slate-800 rounded w-24 mb-4 animate-pulse"></div>
                            <div className="h-8 bg-slate-200 dark:bg-slate-700/50 rounded w-20 animate-pulse"></div>
                        </Card>
                    ))}
                </motion.div>
            ) : stats && (
                <motion.div variants={item} className="grid grid-cols-2 md:grid-cols-4 gap-5 relative z-10 pt-4">
                    <Card className="border border-slate-300 dark:border-slate-700/60 shadow-[0_8px_30px_rgb(0,0,0,0.3)] bg-gradient-to-b from-slate-900/80 to-slate-950/80 backdrop-blur-xl rounded-2xl p-5 relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-2 mb-2 text-slate-600 dark:text-slate-400 relative z-10">
                            <Activity size={16} className="text-indigo-400 drop-shadow-[0_0_8px_rgba(99,102,241,0.5)]" />
                            <span className="text-[11px] font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300">Generations</span>
                        </div>
                        <div className="text-3xl font-extrabold text-slate-900 dark:text-white relative z-10">{stats.total_generations}</div>
                    </Card>
                    <Card className="border border-slate-300 dark:border-slate-700/60 shadow-[0_8px_30px_rgb(0,0,0,0.3)] bg-gradient-to-b from-slate-900/80 to-slate-950/80 backdrop-blur-xl rounded-2xl p-5 relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-2 mb-2 text-slate-600 dark:text-slate-400 relative z-10">
                            ...
                            <span className="text-[11px] font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300">Total Voices</span>
                        </div>
                        <div className="text-3xl font-extrabold text-slate-900 dark:text-white relative z-10">{stats.total_voices}</div>
                    </Card>
                    <Card className="border border-slate-300 dark:border-slate-700/60 shadow-[0_8px_30px_rgb(0,0,0,0.3)] bg-gradient-to-b from-slate-900/80 to-slate-950/80 backdrop-blur-xl rounded-2xl p-5 relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-2 mb-2 text-slate-600 dark:text-slate-400 relative z-10">
                            ...
                            <span className="text-[11px] font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300">Audio Storage</span>
                        </div>
                        <div className="text-3xl font-extrabold text-slate-900 dark:text-white relative z-10">{(stats.total_storage / 1024 / 1024).toFixed(1)} <span className="text-lg text-slate-500 dark:text-slate-500 font-bold">MB</span></div>
                    </Card>
                    <Card className="border border-slate-300 dark:border-slate-700/60 shadow-[0_8px_30px_rgb(0,0,0,0.3)] bg-gradient-to-b from-slate-900/80 to-slate-950/80 backdrop-blur-xl rounded-2xl p-5 relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-2 mb-2 text-slate-600 dark:text-slate-400 relative z-10">
                            ...
                            <span className="text-[11px] font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300">Total Chars</span>
                        </div>
                        <div className="text-3xl font-extrabold text-slate-900 dark:text-white relative z-10">{stats.total_characters?.toLocaleString() || 0}</div>
                    </Card>
                </motion.div>
            )}
            ...
            {loading ? (
                <motion.div variants={item} className="relative z-10 pt-4 pb-4">
                    <h2 className="text-xl font-extrabold tracking-tight mb-4 flex items-center gap-2 text-slate-500 dark:text-slate-500">
                        <div className="w-5 h-5 rounded-full bg-slate-100 dark:bg-slate-800 animate-pulse"></div>
                        <div className="h-6 bg-slate-100 dark:bg-slate-800 rounded w-56 animate-pulse"></div>
                    </h2>
                    <Card className="border border-slate-300 dark:border-slate-700/60 p-0 overflow-hidden bg-white/90 dark:bg-slate-900/40 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.3)] rounded-2xl">
                        <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-700/50">
                            {[1, 2, 3].map(i => (
                                <div key={i} className="p-6">
                                    <div className="h-5 bg-slate-100 dark:bg-slate-800 rounded w-36 mb-4 animate-pulse"></div>
                                    <div className="h-6 bg-slate-100 dark:bg-slate-800/50 rounded w-24 animate-pulse"></div>
                                </div>
                            ))}
                        </div>
                    </Card>
                ...
                <motion.div variants={item} className="relative z-10 pt-4 pb-4">
                    <h2 className="text-xl font-extrabold tracking-tight mb-4 flex items-center gap-2 text-slate-900 dark:text-white">
                        <Server className="text-indigo-400" size={20} /> System Engine Status
                    </h2>
                    <Card className="border border-slate-300 dark:border-slate-700/60 p-0 overflow-hidden bg-gradient-to-b from-slate-900/90 to-slate-950/90 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.4)] rounded-2xl">
                        <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-700/50">
                            {engineStatus.engines.map((engine, idx) => (
                                <div key={idx} className="p-6 hover:bg-white/[0.02] transition-colors relative group">
                                    ...
                                    <div className="relative z-10 flex justify-between items-start mb-4">
                                        <h3 className="font-bold text-base text-slate-900 dark:text-white">{engine.name}</h3>
                                        {engine.available ? 
                            ...
                            <div className="p-6 hover:bg-white/[0.02] transition-colors relative group">
                                <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                <div className="relative z-10 flex justify-between items-start mb-4">
                                    <h3 className="font-bold text-base text-slate-900 dark:text-white">Coqui XTTS Neural</h3>
